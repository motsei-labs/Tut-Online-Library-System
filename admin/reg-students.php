...
<head>
    ...
    <title>TUT | Online Library Management System | Manage Registered Students</title>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          Registered Students
                          <a href="#" id="exportStudentsPDF" class="btn btn-success btn-sm pull-right">Export to PDF</a>
                        </div>
...
$(document).ready(function() {
    ...
    $('#exportStudentsPDF').on('click', function(e) {
        e.preventDefault();
        var search = table.search();
        var url = 'export-students-pdf.php';
        if(search) {
